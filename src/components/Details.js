        ...
        <div className="w-full pt-4">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex-1 py-8 w-[85%] mx-auto md:w-full">
              ...
              {/* <p className="text-xl bg-black w-fit px-4 py-1 rounded-2xl mt-1">
              ...
              <div className="buttons flex items-center gap-4 pt-4">
                <button className="bg-indigo-700 px-4 py-2 rounded">
                  BUY NOW
                </button>
              ...
              <p className="pt-4"><span className="text-xl">💯</span>Original Products</p>
            </div>
          </div>
        </div>
      )}
